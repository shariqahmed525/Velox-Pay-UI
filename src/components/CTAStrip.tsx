      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center space-x-2 bg-light-glass dark:bg-dark-glass border border-light-border dark:border-dark-border px-4 py-2 rounded-xl hover:border-primary/30 transition-all duration-300"
          >
          ...
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center space-x-2 bg-primary text-white px-4 py-2 rounded-xl font-medium hover:shadow-glow transition-all"
          >
          ...
          <div className="w-12 h-12 bg-light-glass dark:bg-dark-glass border border-light-border dark:border-dark-border rounded-lg flex items-center justify-center transition-colors duration-300">
            <div className="w-8 h-8 bg-primary/20 rounded-sm flex items-center justify-center">
              <div className="w-4 h-4 bg-primary rounded-xs"></div>
            </div>
          </div>
        </motion.div>
      </div>
