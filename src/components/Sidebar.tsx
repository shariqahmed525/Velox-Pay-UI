...
import { Wallet, TrendingUp, Send, BarChart3, Settings, ChevronLeft, ChevronRight, Bell, User } from 'lucide-react';
    ...
    >
      ...
      <div className="p-6 border-b border-light-border dark:border-dark-border flex items-center justify-between">
        ...
        >
          {!isCollapsed && (
            <div>
              <h1 className="text-lg font-bold text-primary font-display">VeloxPay</h1>
              <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">Smart Banking</p>
            </div>
          )}
        </motion.div>
        <button
          ...
          <motion.button
            ...
            className={`w-full flex items-center space-x-4 p-4 rounded-xl transition-all relative group ${
              activeSection === item.id
                ...
                : 'text-light-text dark:text-dark-text hover:bg-light-glass dark:hover:bg-dark-glass hover:text-primary'
            }`}
